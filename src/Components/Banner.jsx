                ...
                <div className="max-w-5xl flex flex-col items-center">
                    <div>
                        ...
                        <div className='flex justify-center gap-4 my-[40px]'>
                            ...
                            <button onClick={() => window.open('https://play.google.com/store/games?hl=en', '_blank')} className="banner-btn gap-1 lg:gap-2  py-1 sm:py-2 md:py-3 lg:py-3.5 xl:py-4 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10 text-[10px] sm:text-[12px] md:text-xs lg:text-sm xl:text-base"><img className='h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-8 lg:w-8' src="/google-play-logo.png" alt="" /> Google Play</button>
                            <button onClick={() => window.open('https://www.apple.com/app-store/', '_blank')} className="banner-btn gap-1 lg:gap-2  py-1 sm:py-2 md:py-3 lg:py-3.5 xl:py-4 px-2.5 sm:px-4.5 md:px-6.5 lg:px-8.5 xl:px-10.5 text-[10px] sm:text-[12px] md:text-xs lg:text-sm xl:text-base"><img className='h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-8 lg:w-8' src="/app-store-logo.png" alt="" /> App Store</button>
                        </div>
                    </div>
